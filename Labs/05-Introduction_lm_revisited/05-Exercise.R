...
#' 5. Using `qt()` function to find the 95% critical value for the test and compare it with the t-statistic you got from Q4. Recall that the degrees of freedom is calculated by the number of observations in the dataset - the number of parameters estimated. 
#' 
# qt(p=0.975, df=_____)

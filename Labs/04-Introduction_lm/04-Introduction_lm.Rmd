...
The data file is `04-Introduction_tidyverse_data.csv`. You can find it on Canvas under `Files` then `Labs`. Download the file and save it somewhere on your computer.[^file] 

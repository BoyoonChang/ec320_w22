...
## use pipe operator
pi %>% sin() %>% cos()
## use pipe operator plus, use `.` as a placeholder to indicate the output of the previous statement
pi %>% sin(.) %>% cos(.)
#' Example 2
...
print("hello")
"hello" %>% print()
# Consider creating following function that concatenates two parameters and print that out. 

...
# Fill in the blank.
# Create a function called add that takes two arguments as the inputs and returns addition of them.
...
# Use previously defined add function to add 3 and 4


# Create a function that takes one argument as the input and returns its square.
...
# Use previously defined square function to square 5

# Create a numeric vector containing 5 elements, 1,1,2,3, and 5

# Select 2 from the previous vector using the index.

# Create a character vector containing 2 elements, your first and your last name.

# Create a tibble that contains two columns year and month, where year = c(2021,2021,2021,2021) and month=c("Sep", "Oct","Nov", "Dec"). 

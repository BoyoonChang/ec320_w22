...
dir_slides <- "~/GitHub/EC320_Econometrics/Lectures/11-Multiple_Linear_Regression_Estimation/"
...
geom_text(aes(x = xl, y = yl, label = l), size = 9, family = "Arial", parse = T) +
xlim(-3, 3) +
ylim(-4, 3.4) +
coord_equal()
```
...
annotate(
  x = 1, y = 3,
  geom = "text", label = "Model 1", size = 9, color = met_slate, family = "Arial", hjust = 0
) +
xlim(-3, 3) +
ylim(-4, 3.4) +
coord_equal()
...
annotate(
  x = 1, y = 3,
  geom = "text", label = "Model 2", color = met_slate, size = 9, family = "Arial", hjust = 0
) +
xlim(-3, 3) +
ylim(-4, 3.4) +
coord_equal()
...
x <- matrix(data = rnorm(1e7), nrow = 1e4) # 10000 by 1000 matrix
...
annotate(
  x = 1, y = 3,
  geom = "text", label = "No Bias", color = met_slate, size = 9, family = "Arial", hjust = 0
) +
xlim(-3, 3) +
ylim(-4, 3.4) +
coord_equal()
...
annotate(
  x = 1, y = 3,
  geom = "text", label = "Bias", color = met_slate, size = 9, family = "Arial", hjust = 0
) +
xlim(-3, 3) +
ylim(-4, 3.4) +
coord_equal()

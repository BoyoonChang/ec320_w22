...
Using the OLS formulas, we get $\hat{\beta_0}$ .mono[=] `r round(lm0$coefficients[1], 2)` and $\hat{\beta_1}$ .mono[=] `r round(lm0$coefficients[2], 2)`.
...
What does $\hat{\beta_0}$ .mono[=] `r round(lm0$coefficients[1], 2)` tell us?

--

What does $\hat{\beta_1}$ .mono[=] `r round(lm0$coefficients[2], 2)` tell us?

...
**A.sub[1]:** Trained workers $(e^{0.557}-1)\times 100$ (`r round((exp(b2)-1)*100, 2)`) percent more productive than untrained workers.
**A.sub[2]:** Untrained workers $(e^{-0.557}-1)\times 100$ (`r (-1)*round((exp(-b2)-1)*100, 2)`) percent less productive than trained workers.

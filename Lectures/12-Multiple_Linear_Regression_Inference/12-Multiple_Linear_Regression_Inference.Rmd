...
1. What do we have to assume to interpret $\beta_1$ as the true effect of coffee consumption on health?
...
- $k$ is the number of parameters (one "slope" for each $X$ variable and an intercept).

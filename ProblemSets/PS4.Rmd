...
($LGEARN$ denotes the logged hourly earnings, $S$ represents years of schoolings, $EXP$ represents the total out-of-school work experience (years), $MALE$ is a binary variable denoting male.)
